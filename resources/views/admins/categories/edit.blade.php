                ...
                <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="col-sm-10 mb-3 d-flex gap-2 ">
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ $Category->trang_thai == true ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ $Category->trang_thai == false ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <img src="{{ Storage::url($Category->hinh_anh) }}" id="img_danh_muc" alt="Hình ảnh sản phẩm" style="width: 150px; display:none ;">
                                </div>
                        </div>
